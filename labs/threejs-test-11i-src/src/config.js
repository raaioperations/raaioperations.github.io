...
export const PLAYER_VITALS=Object.freeze({
  maxHealth:100,
  enemyDamage:15,
  invulnerabilityFrames:18,
  staggerFrames:14
});
...
export const ENEMY_COMBAT=Object.freeze({
  aggroRadius:6.0,
  attackRange:2.35,
  retaliationFrames:600,
  evaluationBudgetPerFrame:4,
  attackStartsPerFrame:1,
...
export const ENEMY_COMBAT_PHASE=Object.freeze({
  READY:'READY',
  TELEGRAPH:'TELEGRAPH',
  STRIKE:'STRIKE',
  RECOVERY:'RECOVERY'
