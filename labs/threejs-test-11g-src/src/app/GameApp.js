...
export class GameApp{
  constructor(container){
    ...
    this.lastInput={moveX:0,moveY:0,sprint:false,jump:false,interact:false,lookDX:0,lookDY:0};
  }
  ...
  mount(){
    ...
    this.canvas.setAttribute('aria-label','RAAI Test11G Copperwash Reach gameplay interaction foundation');
    ...
    this.scheduler.register({
      ...
      update:frame=>this.interaction.update(frame,this.world.playerRoot.position,this.lastInput)
    });
