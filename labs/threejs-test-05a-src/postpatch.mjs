...
'<label><span>Walk <output id="walkTuneV">2.5</output></span><input id="walkTune" type="range" min="1.5" max="5" step="0.1" value="2.5"></label><label><span>Run <output id="runTuneV">6.6</output></span><input id="runTune" type="range" min="3" max="10" step="0.1" value="6.6"></label><label><span>Sprint <output id="sprintDerivedV">11.88</output></span><b style="font-size:9px;opacity:.72">1.8× Run</b></label><label><span>Accel <output id="accelV"></output></span>',
...
'<div class="checkTitle">Test checklist</div><div id="checklist"><div><b>PENDING</b><span>01 Walk — joystick / WASD</span></div><div><b>PENDING</b><span>02 Run — R / mode button</span></div><div><b>PENDING</b><span>03 Sprint — R / mode button · 1.8× Run</span></div><div><b>PENDING</b><span>04 Acceleration response</span></div><div><b>PENDING</b><span>05 Braking response</span></div><div><b>PENDING</b><span>06 Turn response</span></div><div><b>PENDING</b><span>07 Jump</span></div><div><b>PENDING</b><span>08 Gravity + landing</span></div><div><b>PENDING</b><span>09 Camera damping</span></div><div><b>PENDING</b><span>10 Animation ↔ speed match</span></div></div><button id="resetMove">Reset movement defaults</button>',
'checklist');
