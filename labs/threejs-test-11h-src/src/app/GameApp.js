...
export class GameApp{
  ...
  mount(){
    ...
    this.canvas.setAttribute('aria-label','RAAI Test11H Copperwash Reach combat action foundation');
    ...
    this.scheduler.register({
      ...
      update:frame=>this.combat.update(frame,this.world.playerRoot.position,this.lastInput)
    });
