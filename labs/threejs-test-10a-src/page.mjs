export function make10AHtml(index09B,buildId){
  ...
  html=html.replace(
    ...
    '<title>RAAI Three.js Test 10A — Windcut Shelf Replication Proof</title>'
  );
  html=html.replace(/<div id="zone">[^<]*<\/div>/,'<div id="zone">10A · WINDCUT SHELF · REPLICATION PROOF</div>');
